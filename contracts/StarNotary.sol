...
contract StarNotary is ERC721Metadata
{
    ...
    string private constant SYMBOL = "ASN";
    string private constant NAME = "Andrus Star Notary";
    ...
    constructor() ERC721Metadata(NAME, SYMBOL) public {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You can't exchange stars if you are not owner");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You can't transfer a star if you are not owner");
